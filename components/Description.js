			...
			<article className='flex f-center f-column'>
				...
				<ul className={DescStyle.wrap}>
					<li>
						...
						<ul>
							<li>
                                If You agree to use Your geo position, You will see Covid data for Your current position country on top of the table, and nearest siblings data below
							</li>
							<li>
                                If You do not, You will see a default country data
							</li>
							<li>
					...
					<li>
						...
						<ul>
							...
							<li>
                                Click on the color marker to display some details
							</li>
						</ul>
